  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 relative overflow-hidden">
      ...
      <section className="relative overflow-hidden py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-blue-600/90 via-purple-600/90 to-pink-600/90 animate-gradient"></div>
      ...
      <section className="py-16 relative z-10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-8 sticky top-8 border border-gray-200/50 transform hover:shadow-3xl transition-all duration-300">
                ...
                <div className="space-y-6">
                  {contactInfo.map((info, index) => (
                    <div 
                      key={index} 
                      className="flex items-start space-x-4 group p-4 rounded-2xl hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 transition-all duration-300 cursor-pointer"
                    >
                      <div className="w-14 h-14 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 rounded-2xl flex items-center justify-center text-2xl group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-lg group-hover:shadow-xl">
                        {info.icon}
                      </div>
                      <div className="flex-1 pt-1">
                        ...
                        {info.link ? (
                          <a 
                            href={info.link}
                            className="text-gray-700 hover:text-blue-600 font-medium transition-colors inline-flex items-center group/link"
                          >
                            {info.content}
                ...
                <div className="mt-10 pt-8 border-t border-gray-200">
                  ...
                  <div className="flex space-x-3">
                    {[
                      { icon: '📘', label: 'Facebook', href: '#', color: 'from-blue-500 to-blue-600' },
                      { icon: '🐦', label: 'Twitter', href: '#', color: 'from-sky-400 to-sky-500' },
                      { icon: '📷', label: 'Instagram', href: '#', color: 'from-pink-500 to-purple-500' }
                    ].map((social, index) => (
                      <a
                        key={index}
                        href={social.href}
                        className={`w-14 h-14 bg-gradient-to-br ${social.color} rounded-2xl flex items-center justify-center text-2xl hover:scale-110 hover:rotate-6 transition-all duration-300 shadow-lg hover:shadow-xl transform`}
                    ...
                    <div className="group">
                      ...
                      <div className="relative">
                        <input
                          ...
                          required
                          className="w-full px-4 py-3.5 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all bg-white/50 backdrop-blur-sm hover:bg-white hover:border-blue-300 group-hover:shadow-md"
                    ...
                    <div className="group">
                      ...
                      <div className="relative">
                        <select
                          ...
                          onChange={handleChange}
                          required
                          className="w-full px-4 py-3.5 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all bg-white/50 backdrop-blur-sm hover:bg-white hover:border-blue-300 group-hover:shadow-md appearance-none cursor-pointer"
                        >
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      <textarea
                        ...
                        required
                        rows={6}
                        className="w-full px-4 py-3.5 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all resize-none bg-white/50 backdrop-blur-sm hover:bg-white hover:border-blue-300 group-hover:shadow-md"
          ...
          <div className="mt-12 text-center">
            <Link 
              to="/" 
              className="inline-flex items-center px-8 py-3.5 bg-white/80 backdrop-blur-sm border-2 border-gray-200 hover:border-blue-300 text-gray-700 hover:text-blue-600 font-semibold rounded-xl transition-all duration-300 hover:shadow-lg transform hover:-translate-y-0.5"
            >
